...
function UniversalPage({ activePage }) {
  ...
  return (
    <div
      className="h-screen  m-auto  self-center w-full  min-[900px]:w-10/12 text-right static  min-[900px]:absolute right-0"
      onClick={() => {
        if (isOpen) {
          setIsOpen(false);
        }
    ...
    >
      <Header title={activePage} activePage={activePage} />
