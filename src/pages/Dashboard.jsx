...
function Dashboard() {
  ...
  return (
    <div className="w-full  min-[900px]:w-10/12 mt-20 min-[900px]:mt-14  text-right static  min-[900px]:absolute right-0 ">
      ...
      >
        <section className="w-full sm:w-8/12  min-[900px]:w-9/12 right-0  mt-2  min-[900px]:mt-4 min-[900px]:ml-4  px-1 text-left">
          <section
            className=" p-2 border-2 border-[#f3f4f8] rounded-lg"
            id="quick-links"
          >
            <p className="">Quick Links</p>
            <div className="grid grid-cols-3  md:grid-cols-4  xl:grid-cols-7 w-auto gap-2 m-2   items-center">
              {quickLinks.map((e) => (
                <div
                  key={e.title}
          ...
          <section className="mt-4  p-2  border-2 border-[#f3f4f8] rounded-lg">
            ...
            <div className="flex gap-2 text-lg text-[#99a2b3]">
              ...
              <button className="bg-pink-100 px-4 rounded-lg text-[#1d2839]">
                {" "}
                Yearly
              </button>
            </div>
            ...
            <div className="font-roboto mt-4 w-full">
        ...
        <section className="w-full sm:w-5/12 right-0 sm:top-36  mt-3  min-[900px]:mr-4  min-[900px]:mt-4  px-2  text-left">
          <section
            id="trading-accounts"
            className=" px-4  border-2 border-[#f3f4f8] rounded-lg"
          >
            <p className="font-medium text-lg text-[#364456]">
              Trading Accounts
            </p>
            <div className="pb-2">
          ...
          <section className="mt-2  px-4 pb-4 pt-2  border-2 border-[#f3f4f8] rounded-lg">
            ...
            <div>
              {openTrades.map((e) => (
                <div
                  key={e.currencyPair}
                  className="mt-2 p-2 border-2 border-[#f3f4f8] rounded-lg"
                >
                  <div className="flex justify-between">
                    <div className="flex gap-2">
                      <p className="font-medium text-[#657084]">
                        {e.currencyPair}
                      </p>
                      <p
                        className={`px-2 rounded-lg  ${
                          e.position == "Long" ? "bg-[#eaffee]" : "bg-[#feeae9]"
                        }`}
                      >
                        {e.position}
                      </p>
                  ...
                  <p className="font-medium mt-2">
                    <span
                      className={`text-2xl font-bold mr-3 ${
                        e.profit > 0 ? "text-[#15ae5c]" : "text-[#ec221e]"
                      }`}
                    >
                      {e.profit > 0 && "+"}
                      {e.profit.toFixed(2)}
